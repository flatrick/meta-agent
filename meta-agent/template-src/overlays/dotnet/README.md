...
- Build: `dotnet build`
- Run: `dotnet run --project ./src/Project.csproj`
- Test: `dotnet test ./tests/Project.Tests.csproj`

This template uses a standard `Program` entry point and targets `net10.0` by default.
