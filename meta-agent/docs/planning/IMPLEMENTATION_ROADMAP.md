...
Purpose: capture the post-v1.0.0 upgrade plan from the released scaffolder/validator baseline to a full meta-agent system aligned to the original specification.
